...
export default function App() {
  ...
  if (!app) return (
    <div className="flex flex-col items-center justify-center h-screen bg-slate-50 p-6 text-center">
        <h1 className="text-xl font-bold text-red-600 mb-2">Fehlende Konfiguration</h1>
        <p className="text-slate-600">Bitte trage deine Firebase-Daten in die Datei <code>src/App.jsx</code> ein.</p>
        <p className="text-xs text-slate-400 mt-4">Suche nach &quot;const firebaseConfig = &#123;&quot;</p>
    </div>
  );
