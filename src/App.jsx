            ...
            <>
              ...
              {!isMobile && (
                  <div className="flex flex-row h-full w-full divide-x divide-slate-200">
                      ...
                      <div className="flex-1 h-full p-2"><KanbanColumn title={t.colIncoming} status="incoming" appointments={incoming} onClickApp={(app) => { setSelectedAppointment(app); setView('detail'); }} onStatusChange={handleUpdateStatus} isMobile={false} teamMembers={teamMembers} role={role} currentMemberId={currentMemberId} /></div>
                      <div className="flex-1 h-full p-2"><KanbanColumn title={t.colPending} status="pending" appointments={pending} onClickApp={(app) => { setSelectedAppointment(app); setView('detail'); }} onStatusChange={handleUpdateStatus} isMobile={false} teamMembers={teamMembers} role={role} currentMemberId={currentMemberId} /></div>
                      <div className="flex-1 h-full p-2"><KanbanColumn title={t.colReview} status="review" appointments={review} onClickApp={(app) => { setSelectedAppointment(app); setView('detail'); }} onStatusChange={handleUpdateStatus} isMobile={false} teamMembers={teamMembers} role={role} currentMemberId={currentMemberId} /></div>
                      <div className="flex-1 h-full p-2"><KanbanColumn title={t.colDone} status="done" appointments={done} onClickApp={(app) => { setSelectedAppointment(app); setView('detail'); }} onStatusChange={handleUpdateStatus} isMobile={false} teamMembers={teamMembers} role={role} currentMemberId={currentMemberId} /></div>
                  </div>
              )}
              ...
              {isMobile && (
                  <div className="flex flex-col gap-4 p-4 overflow-y-auto h-full custom-scrollbar">
                      {/* Pass teamMembers Prop and ROLE */}
                      <KanbanColumn title={t.colIncoming} status="incoming" appointments={incoming} onClickApp={(app) => { setSelectedAppointment(app); setView('detail'); }} onStatusChange={handleUpdateStatus} isMobile={true} teamMembers={teamMembers} role={role} currentMemberId={currentMemberId} />
                      <KanbanColumn title={t.colPending} status="pending" appointments={pending} onClickApp={(app) => { setSelectedAppointment(app); setView('detail'); }} onStatusChange={handleUpdateStatus} isMobile={true} teamMembers={teamMembers} role={role} currentMemberId={currentMemberId} />
                      <KanbanColumn title={t.colReview} status="review" appointments={review} onClickApp={(app) => { setSelectedAppointment(app); setView('detail'); }} onStatusChange={handleUpdateStatus} isMobile={true} teamMembers={teamMembers} role={role} currentMemberId={currentMemberId} />
                      <KanbanColumn title={t.colDone} status="done" appointments={done} onClickApp={(app) => { setSelectedAppointment(app); setView('detail'); }} onStatusChange={handleUpdateStatus} isMobile={true} teamMembers={teamMembers} role={role} currentMemberId={currentMemberId} />
                  </div>
              )}
            </>
        )}
